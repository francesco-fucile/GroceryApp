...
(async () => {
	try {
		...
		// build day meal for first meal of first day dinner
		results.first_day_dinner_first_meal_map = { [results.first_menu_db.results[5].properties.Name.title[0].text.content]: results.first_day_dinner_first_meal.child_page.title }
	} catch (e) {
